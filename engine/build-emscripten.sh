...
SRCS=(
  ...
  i_sdlsound.c
  aes_prng.c net_client.c net_server.c net_io.c net_packet.c net_loop.c
  net_common.c net_structrw.c net_websockets.c net_gui.c
)

CFLAGS="-DFEATURE_SOUND -sUSE_SDL=2 -sUSE_SDL_MIXER=2 -sSDL2_MIXER_FORMATS=['mid'] -O2"
LDFLAGS="-sASYNCIFY -sINITIAL_MEMORY=64MB -sALLOW_MEMORY_GROWTH=1 -sENVIRONMENT=web --preload-file doom1.wad --shell-file ../web/shell.html -sEXPORTED_FUNCTIONS=_main,_assist_get_episode,_assist_get_map,_assist_get_gamestate,_assist_get_kills,_assist_get_items,_assist_get_secrets,_assist_get_weapon,_assist_is_paused,_assist_toggle_pause,_assist_get_menuactive,_assist_get_demoplayback,_assist_set_move,_assist_set_turn,_assist_get_map_line_count,_assist_get_map_lines,_assist_get_map_bounds,_assist_get_poi_count,_assist_get_poi_data,_assist_get_player_x,_assist_get_player_y,_assist_get_player_angle,_assist_get_player_has_spawned,_assist_get_net_status_seq,_assist_get_net_status_message,_assist_menu_item_count,_assist_menu_base_y,_assist_menu_set_item,_assist_switch_weapon,_assist_set_nomonsters,_assist_get_nomonsters,_assist_net_ws_receive -sEXPORTED_RUNTIME_METHODS=ccall,cwrap,HEAPU8,HEAP32,FS,callMain -lidbfs.js -O2"
